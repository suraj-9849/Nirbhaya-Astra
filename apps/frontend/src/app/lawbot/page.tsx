...
function Page() {
  ...
  if (messages.length === 0) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center">
        <h1 className="text-3xl font-extrabold tracking-wide text-white mb-5">
          {typingText}
        </h1>
        <form
        ...
        >
          <div className="rounded-lg flex w-full items-center bg-slate-100 border border-gray-300 p-1">
            <Input
              {...form.register("message")}
              className="focus-within:ring-0 ring-offset-transparent text-lg text-black focus-visible:ring-0 bg-slate-100 rounded-lg focus-visible:ring-transparent p-5 border-none"
  ...
  return (
    <div className="flex flex-col min-h-[50vh] items-center justify-center max-w-3xl w-full mx-auto ">
      ...
      {messages.length > 0 && (
        <form
          ...
          className="flex items-center max-w-3xl w-full gap-2"
        >
          <div className="rounded-lg flex w-full items-center border bg-slate-100 border-gray-300 p-1">
            <Input
              {...form.register("message")}
              className="focus-within:ring-0 text-black  text-lg bg-slate-100 focus-visible:ring-0 rounded-lg p-5 border-none"
              placeholder="Chat with Law Bot"
              autoComplete="off"
            />
            <Button
